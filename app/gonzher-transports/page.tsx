              ...
              <div>
                ...
                <div className="flex flex-col items-start space-y-4">
                  <p className="mx-auto max-w-[700px] text-primary-foreground md:text-xl pt-6">
                    Nuestra flota de camiones de carga pesada y conductores experimentados está lista para manejar todas sus necesidades de transporte de carga. <strong>Nos especializamos en camiones 3/5.</strong>
                  </p>
                </div>
              </div>
              <div>
