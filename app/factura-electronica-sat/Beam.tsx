...
import { File, FileArchiveIcon, FileBarChart, Landmark, MapPinIcon, Truck, Users } from "lucide-react";
    ...
    >
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref}>
            <Truck className="size-8 text-xl"/>
          </Circle>
          <Circle ref={div5Ref}>
            <MapPinIcon className="size-8 text-xl"/>
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref}>
            <Users className="size-8 text-xl"/>
          </Circle>
          <Circle ref={div4Ref} className="size-16">
            <Image src="/logo.png" alt="gonzher-logo" height="40" width="40"/>
          </Circle>
          <Circle ref={div6Ref}>
            <Landmark className="size-8 text-xl"/>
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref}>
            <FileBarChart className="size-8 text-xl"/>
          </Circle>
          <Circle ref={div7Ref}>
            <FileArchiveIcon className="size-8 text-xl"/>
          </Circle>
        </div>
      </div>
