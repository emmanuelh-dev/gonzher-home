      ...
      <div className="flex flex-wrap -mx-4 ">
        <div className="w-full md:w-1/2 lg:w-1/4 px-4">
          <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".1s">
            <div
              ...
              "
            >
              <span className="   w-[70px]   h-[70px]   flex   items-center   justify-center   bg-primary bg-opacity-20   rounded-2xl   mb-8   absolute   z-[-1]   top-0   left-0   rotate-[25deg]   group-hover:rotate-45   duration-300 "
              ></span>
            ...
            Software de Transporte Avanzado
            </h4>
            <p className="text-body-color mb-8 lg:mb-11">
            Nuestra empresa de transportes se enorgullece de ofrecer soluciones de software y herramientas avanzadas para la industria del transporte.
          ...
          >
            ...
            <h4 className="font-bold text-xl text-dark mb-3">
              ...
              <p className="text-body-color">
                Mantenga un seguimiento en tiempo real de sus envíos para una
                mayor visibilidad y tranquilidad.
              </p>
            <a
              href="javascript:void(0)"
              className="font-medium text-base text-body-color hover:text-primary"
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 px-4">
          <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".2s">
            ...
            >
              ...
              > <path   d="M10.7734 14.3281H3.82813C2.07813 14.3281 0.65625 12.9062 0.65625 11.1562V4.21094C0.65625 2.46094 2.07813 1.03906 3.82813 1.03906H10.7734C12.5234 1.03906 13.9453 2.46094 13.9453 4.21094V11.1562C13.9453 12.9062 12.5234 14.3281 10.7734 14.3281ZM3.82813 2.95312C3.17188 2.95312 2.57031 3.5 2.57031 4.21094V11.1562C2.57031 11.8125 3.11719 12.4141 3.82813 12.4141H10.7734C11.4297 12.4141 12.0313 11.8672 12.0313 11.1562V4.21094C12.0313 3.55469 11.4844 2.95312 10.7734 2.95312H3.82813Z"   fill="white" /> <path   d="M31.1719 14.3281H24.2266C22.4766 14.3281 21.0547 12.9062 21.0547 11.1562V4.21094C21.0547 2.46094 22.4766 1.03906 24.2266 1.03906H31.1719C32.9219 1.03906 34.3438 2.46094 34.3438 4.21094V11.1562C34.3438 12.9062 32.9219 14.3281 31.1719 14.3281ZM24.2266 2.95312C23.5703 2.95312 22.9688 3.5 22.9688 4.21094V11.1562C22.9688 11.8125 23.5156 12.4141 24.2266 12.4141H31.1719C31.8281 12.4141 32.4297 11.8672 32.4297 11.1562V4.21094C32.4297 3.55469 31.8828 2.95312 31.1719 2.95312H24.2266Z"   fill="white" /> <path   d="M10.7734 33.9609H3.82813C2.07813 33.9609 0.65625 32.5391 0.65625 30.7891V23.8438C0.65625 22.0938 2.07813 20.6719 3.82813 20.6719H10.7734C12.5234 20.6719 13.9453 22.0938 13.9453 23.8438V30.7891C13.9453 32.5391 12.5234 33.9609 10.7734 33.9609ZM3.82813 22.5859C3.17188 22.5859 2.57031 23.1328 2.57031 23.8438V30.7891C2.57031 31.4453 3.11719 32.0469 3.82813 32.0469H10.7734C11.4297 32.0469 12.0313 31.5 12.0313 30.7891V23.8438C12.0313 23.1875 11.4844 22.5859 10.7734 22.5859H3.82813Z"   fill="white" /> <path   d="M31.1719 33.9609H24.2266C22.4766 33.9609 21.0547 32.5391 21.0547 30.7891V23.8438C21.0547 22.0938 22.4766 20.6719 24.2266 20.6719H31.1719C32.9219 20.6719 34.3438 22.0938 34.3438 23.8438V30.7891C34.3438 32.5391 32.9219 33.9609 31.1719 33.9609ZM24.2266 22.5859C23.5703 22.5859 22.9688 23.1328 22.9688 23.8438V30.7891C22.9688 31.4453 23.5156 32.0469 24.2266 32.0469H31.1719C31.8281 32.0469 32.4297 31.5 32.4297 30.7891V23.8438C32.4297 23.1875 31.8828 22.5859 31.1719 22.5859H24.2266Z"   fill="white" />
              </svg>
            </div>
            <h4 className="font-bold text-xl text-dark mb-3">
            ...
            <p className="text-body-color mb-8 lg:mb-11">
            Nos esforzamos por ofrecer software de primera calidad diseñado específicamente para las necesidades de su negocio de transporte.            </p>
            <a
              href="javascript:void(0)"
              className="font-medium text-base text-body-color hover:text-primary"
            >
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 px-4">
          ...
          >
            ...
            <p className="text-body-color mb-8 lg:mb-11">
            Nuestro software incluye todas las características esenciales que su empresa de transporte necesita para prosperar en el mercado actual.            </p>
            <a
              href="javascript:void(0)"
              className="font-medium text-base text-body-color hover:text-primary"
            >
